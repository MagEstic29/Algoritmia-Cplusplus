...
int main (){
    ...
    Sleep(500);
    cout<<"    [7] Bug: Se puede sobreescribir la coordenada, no lo hagas :v"<<endl;
    Sleep(1000);
    cout<<endl; cout<<endl;
                ...
                if (jugadas%2==1){
                    ...
                    do {
                        ...
                        if(gato[fila][col]=='x'||gato[fila][col]=='o'){
                        	cout<<"Incorrecto, lugar ocupado, intente de nuevo."<<endl;
						}
                    } while((fila>=3||col>=3)||(gato[fila][col]=='x'||gato[fila][col]=='o'));
                    gato[fila][col]='x';
                    imprimir();
